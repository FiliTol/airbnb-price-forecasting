...
print("Importing dataset and other data1...")
df_listings = concatenate_listings_datasets()
host_locations = handler.import_from_json("data1/mappings/host_locations.json")
remap_baths = handler.import_from_json("data1/mappings/baths.json")
print("Data imported!")
...
pd.to_pickle(
    cleaned_df,
    f"data1/pickles/total_listings_viz.pkl",
)

with open("data1/visual/feature_preprocessor.html", "w") as f:
