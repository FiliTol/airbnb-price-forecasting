...
# - one for the actual prediction, providing empty slots for input data1 and some KPIs for the results
...
cleaned_df = pd.read_pickle("data1/pickles/total_listings_viz.pkl")
...
st.markdown(
    """
Description: Provide a brief description of the dataset, including the number of rows, columns, and data1 types.
"""
)
...
if st.toggle("Take a peak to the cleaned dataset"):
    ...
    st.markdown(
        """
    Add some text to describe the bar chart showing the distribution of different data1 types
    """
    )
